...
noktasında **katlanabilir düzenleme** itki yaklaşık **6.37 N**,
**20 cm temel pervane** itki **3.73 N** seviyesindedir; bu da
yaklaşık **%70.9 itki kazancı** anlamına gelir. Aynı
çalışma noktasında **sabit 25 cm referans pervane** (**9.10 N**)
karşısında katlanabilir düzenleme yaklaşık **%30.0 itki açığı**
