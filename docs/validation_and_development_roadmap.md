...
| **[GEOM-04 — planlandı](geom04_execution_plan.md)** | 04A üçgen mesafesi → 04B sürekli yol → 04C1/C2 donanım sözleşmesi/sorguları → 04D arayüz | İlk teslim 04A; her artım TDD ve bağımsız review; Gemini beklenmez, erişimde Cursor Bugbot kontrol edilir; fiziksel yeterlilik üretilmez |
